...
namespace FileInterface
{
    ...
    {
        bool addRow(const  std::string& fileName, const std::string& pathToFile, const std::string& text); //
        bool removeRow(const std::string& fileName, const std::string& pathToFile, const std::string& pattern); //
        std::unique_ptr<std::string> removeRowField(const std::string& row, const int fieldNumber);
        bool updateRow(const std::string& fileName, const std::string& pathToFile, const std::string& newRow, const std::string& where);
